  ...
  container.innerHTML = `
    <div class="table-container">
      ...
      <div style="overflow-x:auto;">
        <table>
          <thead>
            <tr><th>#</th><th>العنوان</th><th>السعر</th><th>الحالة</th><th>مميز</th><th>الإجراءات</th></tr>
          </thead>
...
async function loadServices() {
  ...
  try {
    ...
    servicesData = [];
    snap.forEach(doc => servicesData.push({ id: doc.id, ...doc.data() }));
...
function deleteServiceHandler(id) {
  ...
  document.getElementById('modalBody').innerHTML = `<p>هل أنت متأكد من حذف هذه الخدمة؟</p><p style="color:red;font-weight:bold;">لا يمكن التراجع عن هذا الإجراء.</p>`;
